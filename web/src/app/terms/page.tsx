    ...
    <div style={{ background: 'var(--bg-primary)', minHeight: '100vh' }}>
      ...
      <div className="container section" style={{ maxWidth: '800px' }}>
        ...
        <div style={{ color: 'var(--text-secondary)', lineHeight: 1.8, fontSize: '0.95rem' }}>
          ...
          <p>Subscriptions are billed monthly or annually via Razorpay. A 2-day free trial is provided. After the trial, the selected plan will be charged automatically. Commissions apply to all orders and bookings as per the selected plan.</p>
